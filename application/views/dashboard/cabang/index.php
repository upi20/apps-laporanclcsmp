...
<body>
    ...
    <div class="notification-area" style="margin-top: 0px">
      <div class="container">
        ...
        <div class="alert unread custom-alert-3 alert-primary" role="alert">
          <i class="fa fa-file-text-o fa-2x" style="margin-right: 20.56px;" aria-hidden="true"></i>
          <div class="alert-text w-100">
            <h6 class="text-truncate">Jumlah RAB</h6>
            <div class="d-flex justify-content-between">
              <div class="col-6">
                <span class="text-truncate text-ringgit"><?= $rab['total_harga_ringgit'] ?></span>
              </div>
              <div class="col-6 text-end">
                <span class="text-truncate text-ringgit"><?= $rab['total_harga_rupiah'] ?></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="alert unread custom-alert-3 alert-primary" role="alert">
          ...
          <div class="alert-text w-100">
            <h6 class="text-truncate">Jumlah Saldo</h6>
            <div class="d-flex justify-content-between">
              <div class="col-6">
                <span class="text-truncate text-ringgit"><?= $saldo['total_ringgit'] ?></span>
              </div>
              <div class="col-6 text-end">
                <span class="text-truncate text-rupiah"><?= $saldo['total_rupiah'] ?></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="alert unread custom-alert-3 alert-primary" role="alert">
          ...
          <div class="alert-text w-100">
            ...
            <div class="d-flex justify-content-between">
              <div class="col-6">
                <span class="text-truncate text-ringgit"><?= $realisasi['harga_ringgit'] ?></span>
              </div>
              <div class="col-6 text-end">
                <span class="text-truncate text-rupiah"><?= $realisasi['harga_rupiah'] ?></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="alert unread custom-alert-3 alert-primary" role="alert">
          ...
          <div class="alert-text w-100">
            ...
            <div class="d-flex justify-content-between">
              <div class="col-6">
                <span class="text-truncate text-ringgit"><?= $dialihkan['jumlah_ringgit'] ?></span>
              </div>
              <div class="col-6 text-end">
                <span class="text-truncate text-rupiah"><?= $dialihkan['jumlah_rupiah'] ?></span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="alert unread custom-alert-3 alert-primary" role="alert">
          ...
          <div class="alert-text w-100">
            <h6 class="text-truncate">Jumlah Hutang</h6>
            <div class="d-flex justify-content-between">
              <div class="col-6">
                <span class="text-truncate text-ringgit"><?= $hutang['jumlah'] == null ? 0 : $hutang['jumlah']  ?></span>
              </div>
              <div class="col-6 text-end">
                <a href="<?= base_url('hutang') ?>" class="btn btn-warning">Bayar Hutang</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <script src="<?= base_url() ?>assets/page/home/admin/index.js"></script>
</body>
