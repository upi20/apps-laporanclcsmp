...
class Proposal extends Render_Controller
{
    ...
    public function ajax_data()
    {
        if ($this->session->userdata("data")['level'] == "Admin Sekolah") {
            ...
            $result = $this->proposal->getAllData($id);
    ...
    public function detail($id_cabang, $id_proposal, $status)
    {
        if ($this->session->userdata("data")['level'] == "Admin Sekolah") {
            $list = $this->proposal->getDataDetailAll($id_cabang, $id_proposal, $status);
            $data['lists'] = $list == null ? [] : $list;
